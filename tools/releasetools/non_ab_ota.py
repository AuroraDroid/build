...
""" % bcb_dev)
  ...
  date = target_info.GetBuildProp("ro.aurora.build.date")
  version = target_info.GetBuildProp("ro.aurora.version")

  if target_info.GetBuildProp("ro.product.model") is not None:
    model = target_info.GetBuildProp("ro.product.model")
    script.Print("***********************************************");
    script.Print("           AuroraDroid for %s"%(model));
    script.Print("               BY: Kamlesh Patel               ");
    ...
    script.Print("***********************************************");
    script.Print("           AuroraDroid for %s"%(name));
    script.Print("               BY: Kamlesh Patel               ");
    script.Print("   VERSION: %s"%(version));
    script.Print("   COMPILED ON: %s"%(date));
    script.Print("***********************************************");
